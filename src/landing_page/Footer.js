...
function Footer() {
  return (
    ...
    <div className="container border-top mt-5">
      <div className="row mt-5">
        ...
        <div className="col">
          ...
          <a href=""  style={{textDecoration:"none"}}> Referal programme</a> <br />
        ...
        <div className="col" >
          ...
          <a href=" " style={{textDecoration:"none"}}>resources</a> <br />
          <a href=" " style={{textDecoration:"none"}}>Videos</a> <br />
          <a href=" " style={{textDecoration:"none"}}>Market overview </a> <br />
          <a href=" " style={{textDecoration:"none"}}>How to file a</a> <br />
          <a href=" " style={{textDecoration:"none"}}>complaint?</a> <br />
          <a href=" " style={{textDecoration:"none"}}>Status of your </a> <br />
          <a href=" " style={{textDecoration:"none"}}>complaints</a> <br />
        </div>
        <div className="col">
          <p>Account</p>
    ...
    <a href="" className=" m-3" style={{textDecoration:"none"}}>NSE </a>
    <a href="" className=" m-3" style={{textDecoration:"none"}}>BSE</a>
    <a href=""className=" m-3" style={{textDecoration:"none"}}>MCX</a>
    <a href=""className=" m-3" style={{textDecoration:"none"}}>Terms & conditions </a>
    <a href=""className=" m-3" style={{textDecoration:"none"}}>Policies & procedures </a>
    <a href=""className=" m-3" style={{textDecoration:"none"}}>Privacy policy </a>
    <a href=""className=" m-3" style={{textDecoration:"none"}}>Disclosure </a>
    <a href=""className=" m-3" style={{textDecoration:"none"}}>For investor's attention</a>
    <a href=""className=" m-3" style={{textDecoration:"none"}}>Investor charter</a>
    </p>
